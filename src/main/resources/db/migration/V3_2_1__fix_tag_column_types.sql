-- Fix column types in tags and task_tags tables to match JPA entity expectations
...
-- Create tags table with correct column types
CREATE TABLE tags
(
...
-- Create task_tags junction table with correct column types
